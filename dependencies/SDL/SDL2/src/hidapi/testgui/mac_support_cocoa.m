...
- (void) handleQuitEvent:(NSAppleEventDescriptor*)
event withReplyEvent
...
init_apple_message_system() {
    static MyAppDelegate *d = [MyAppDelegate
    new];

    [[NSApplication
    sharedApplication] setDelegate:
    d];
...
void
check_apple_events() {
    NSApplication * app = [NSApplication
    sharedApplication];
