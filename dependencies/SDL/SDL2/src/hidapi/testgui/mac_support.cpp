...
HandleQuitMessage(const AppleEvent *theAppleEvent, AppleEvent
...
HandleReopenMessage(const AppleEvent *theAppleEvent, AppleEvent
*reply, long handlerRefcon) {
    puts("Showing");
    g_main_window->show();
    return 0;
...
HandleWildCardMessage(const AppleEvent *theAppleEvent, AppleEvent
*reply, long handlerRefcon) {
    puts("WildCard\n");
    return 0;
}
